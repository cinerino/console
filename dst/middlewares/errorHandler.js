...
exports.default = (err, __, res, next) => {
    ...
    if (err instanceof api_1.APIError) {
        ...
        else if (err instanceof api_nodejs_client_1.factory.errors.Cinerino) {
            apiError = new api_1.APIError(cinerinoError2httpStatusCode(err), [err]);
        }
        else {
            // 500
            apiError = new api_1.APIError(http_status_1.INTERNAL_SERVER_ERROR, [new api_nodejs_client_1.factory.errors.Cinerino('InternalServerError', err.message)]);
        }
    }
...
function cinerinoError2httpStatusCode(err) {
    ...
    switch (true) {
        // 401
        case (err instanceof api_nodejs_client_1.factory.errors.Unauthorized):
            statusCode = http_status_1.UNAUTHORIZED;
            break;
        // 403
        case (err instanceof api_nodejs_client_1.factory.errors.Forbidden):
            statusCode = http_status_1.FORBIDDEN;
            break;
        // 404
        case (err instanceof api_nodejs_client_1.factory.errors.NotFound):
            statusCode = http_status_1.NOT_FOUND;
            break;
        // 409
        case (err instanceof api_nodejs_client_1.factory.errors.AlreadyInUse):
            statusCode = http_status_1.CONFLICT;
            break;
        // 429
        case (err instanceof api_nodejs_client_1.factory.errors.RateLimitExceeded):
            statusCode = http_status_1.TOO_MANY_REQUESTS;
            break;
        // 502
        case (err instanceof api_nodejs_client_1.factory.errors.NotImplemented):
            statusCode = http_status_1.NOT_IMPLEMENTED;
            break;
        // 503
        case (err instanceof api_nodejs_client_1.factory.errors.ServiceUnavailable):
