...
(req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.query.format === 'datatable') {
            ...
            const stream = yield streamingOrderService.download(Object.assign(Object.assign({}, searchConditions), { format: cinerinoapi.factory.chevre.encodingFormat.Text.csv, limit: undefined, page: undefined }));
            ...
            const stream = yield streamingOrderService.download(Object.assign(Object.assign({}, searchConditions), { format: cinerinoapi.factory.chevre.encodingFormat.Application.json, limit: undefined, page: undefined }));
            const filename = 'OrderReport';
