...
(req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (req.query.format === 'datatable') {
            ...
            const stream = yield placeOrderService.stream(Object.assign(Object.assign({}, searchConditions), { format: cinerinoapi.factory.chevre.encodingFormat.Text.csv }));
            ...
            const stream = yield placeOrderService.stream(Object.assign(Object.assign({}, searchConditions), { format: cinerinoapi.factory.chevre.encodingFormat.Application.json }));
            const filename = 'TransactionReport';
