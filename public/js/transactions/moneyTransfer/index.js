$(function () {
        ...
        columns: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    return '<ul class="list-unstyled">'
                        ...
                        + '<li><a target="_blank" href="/projects/' + PROJECT_ID + '/transactions/moneyTransfer/' + data.id + '">' + data.id + '</a></li>'
            ...
            },
            {
                data: null,
                render: function (data, type, row) {
                    var url = '/projects/' + PROJECT_ID + '/resources/' + data.recipient.typeOf + '/' + data.recipient.id;
                    var html = '<ul class="list-unstyled">'
                        + '<li><span class="badge badge-secondary ' + data.recipient.typeOf + '">' + data.recipient.typeOf + '</span></li>'
                        + '<li><a target="_blank" href="' + url + '">' + data.recipient.id + '</a></li>'
                        + '<li>' + data.recipient.name + '</li>'
                        + '<li>' + data.recipient.telephone + '</li>'
                        + '<li>' + data.recipient.url + '</li>'
                        + '</ul>';
    ...
    $('.downloadCSV').click(function () {
        var url = '/projects/' + PROJECT_ID + '/transactions/moneyTransfer?' + $('form').serialize() + '&format=text/csv';
        window.open(url, '_blank');
    });
    $('.downloadJson').click(function () {
        var url = '/projects/' + PROJECT_ID + '/transactions/moneyTransfer?' + $('form').serialize() + '&format=application/json';
        window.open(url, '_blank');
    });
