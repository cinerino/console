$(function () {
    ...
    if (accountType === '') {
        ...
        $("#actions-table").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/projects/' + PROJECT_ID + '/accounts/actions/moneyTransfer?' + $('form').serialize(),
                data: function (d) {
                    d.limit = d.length;
                    ...
                    render: function (data, type, row) {
                        ...
                        if (fromLocation.accountType !== undefined) {
                            html += '<li>'
                                ...
                                + ' <span><a target="_blank" href="/projects/' + PROJECT_ID + '/accounts/' + fromLocation.accountType + '/' + fromLocation.accountNumber + '">' + fromLocation.accountNumber + '</a></span>'
                                + '</li>';
                        }
                    ...
                    render: function (data, type, row) {
                        ...
                        if (toLocation.accountType !== undefined) {
                            html += '<li>'
                                ...
                                + ' <span><a target="_blank" href="/projects/' + PROJECT_ID + '/accounts/' + toLocation.accountType + '/' + toLocation.accountNumber + '">' + toLocation.accountNumber + '</a></span>'
                                + '</li>';
                        }
